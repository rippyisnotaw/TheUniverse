...
Game.Launch=function()
{
  ...
  Game.Init=function()
  {
    ...
    Game.CalculateGains=function()
    {
      ...
      mult+=parseFloat(Game.prestige['Heavenly chips'])*0.01;
    ...
    Game.goldenCookie.click=function()
    {
      if (Game.goldenCookie.life>0)
      {
        ...
        else if (choice=='chain cookie')
        {
          ...
          if ((Math.random()<0.1 || Game.goldenCookie.chain>14 || moni>=Game.cookies*0.5) && Game.goldenCookie.chain>4) Game.goldenCookie.chain=0;
          Game.Earn(moni);
        }
      }
    }
    ...
    Game.UpdateMenu=function()
    {
      ...
      if (Game.onMenu=='log')
      {
        ...
        '<div class="listing">-more dungeons</div>'+
        ...
        '<div class="listing">-this is a beta (it will undergo several changes before being applied to the live version)</div>'+
      ...
      else if (Game.onMenu=='stats')
      {
        ...
        date=Game.sayTime(date.getTime()/1000*Game.fps,2);
    ...
    new Game.Object('Antimatter condenser','antimatter condenser|antimatter condensers|condensed','Condenses the antimatter in the universe into cookies.','antimattercondenser','antimattercondenserIcon','antimattercondenserBackground',4999999999,function(){
    ...
    order=300;
    new Game.Upgrade('Cheap hoes','Farms gain <b>+0.5</b> base CpS.<q>Rake in the dough!</q>',Game.Objects['Farm'].basePrice*tier1,[2,0]);
    ...
    //I remember the first time I saw her, amidst the cookie crops.
    ...
    //Her eyes like a burning furnace; my heart like a racing engine.
    ...
    //It was as if she could pierce through me, burrow at my deepest.
    ...
    //In that moment, the universe felt empty, save for just her and me.
    ...
    //I could feel it growing in me. Changing me... making me something else, something better.
    ...
    //There was no way she was of this world. Her very mind was... alien, pervasive; a distortion of the real thing.
    ...
    //She was not what I had first assumed; she was from another time, another eon altogether.
    ...
    //And with her hair... sparkling like starlight... she whispered something.
    ...
    */
    ...
    order=30600;
    new Game.Achievement('Speed baking I','Get to <b>1 million</b> cookies baked in <b>35 minutes</b>.',[12,5],3);
    new Game.Achievement('Speed baking II','Get to <b>1 million</b> cookies baked in <b>25 minutes</b>.',[13,5],3);
    new Game.Achievement('Speed baking III','Get to <b>1 million</b> cookies baked in <b>15 minutes</b>.',[14,5],3);



    order=61000;
    new Game.Achievement('Getting even with the oven','Defeat the <b>Sentient Furnace</b> in the factory dungeons.',[12,7],2);
    new Game.Achievement('Now this is pod-smashing','Defeat the <b>Ascended Baking Pod</b> in the factory dungeons.',[12,7],2);
    new Game.Achievement('Chirped out','Find and defeat <b>Chirpy</b>, the dysfunctionning alarm bot.',[13,7],3);
    new Game.Achievement('Follow the white rabbit','Find and defeat the elusive <b>sugar bunny</b>.',[14,7],3);
  ...
  Game.Logic=function()
  {
    ...
    if (Game.T%(Game.fps*5)==0 && Game.ObjectsById.length>0)//check some achievements and upgrades
    {
      ...
      if (timePlayed<=1000*60*35 && Game.cookiesEarned>=1000000) Game.Win('Speed baking I');
      if (timePlayed<=1000*60*25 && Game.cookiesEarned>=1000000) Game.Win('Speed baking II');
      if (timePlayed<=1000*60*15 && Game.cookiesEarned>=1000000) Game.Win('Speed baking III');
  ...
  Game.MilkPics={0:'milkWave',1:'chocolateMilkWave',2:'raspberryWave'};
  ...
  Game.Draw=function()
  {
    ...
    if (Game.prefs.milk)
    {
      ...
      m2o=1-m1o;
      m1i=Game.MilkPics[m1i];
      m2i=Game.MilkPics[m2i];
